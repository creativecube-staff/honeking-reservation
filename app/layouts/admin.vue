        ...
        <div class="flex min-w-0 flex-1 flex-col">
          ...
          <div class="-ml-1 flex items-stretch">
            ...
            <nav class="admin-nav relative flex flex-1 items-end gap-1 overflow-x-auto">
              <TransitionGroup name="navtab">
                <NuxtLink
                  ...
                  :key="item.to"
                  :to="item.to"
                  class="admin-nav-tab flex items-center gap-1 rounded-t-md border-x border-t px-2 h-8 text-[13px] font-semibold whitespace-nowrap transition-colors"
            ...
            <div class="account-menu group relative flex shrink-0 items-end pl-1">
              <button
                type="button"
                class="account-menu-button flex items-center rounded-t-md border-x border-t border-orange-500 bg-slate-100 px-1.5 h-8 text-orange-600 transition-colors group-hover:bg-orange-600 group-hover:text-white group-focus-within:bg-orange-600 group-focus-within:text-white"
