    ...
    topics: [
      {
        ...
        body: [
          ...
          + '<li><strong>店舗名（例: 流山おおたかの森整骨院）を選ぶ</strong> → その店舗の日々のオペレーション用モード。ナビが「予約管理・お客様管理・口コミ管理・メール管理・LINE管理・メニュー管理・商品管理・スタッフ管理・売上管理」に変わります。<br><span class="text-xs text-slate-500">※ 口コミ管理・メール管理・LINE管理は現在準備中です。</span></li>'
          + '</ul>',
    ...
    topics: [
      {
        ...
        body: [
          ...
          + '<li><strong>店舗特別メニュー</strong> = その店舗だけのメニュー（その店だけのキャンペーン・独自施術 など）。画面右上で<strong>対象店舗（例: 流山おおたかの森整骨院）</strong>を選ぶとナビが店舗用に切り替わり、「<strong>メニュー管理</strong>」タブから登録できます。</li>'
          + '</ul>',
      ...
      },
      {
        ...
        body: [
          ...
          '<ol>'
          + '<li>画面右上で対象店舗（例: 流山おおたかの森整骨院）を選び、「<strong>メニュー管理</strong>」タブを開く</li>'
